    ...
    <div className="flex flex-col gap-3 sm:gap-2 sm:flex-row sm:items-center sm:justify-between bg-[#eceef0] dark:bg-[#1d2027] border border-[#c2c6d6] dark:border-[#424754] rounded-2xl p-3 sm:p-4 shrink-0">
      <div className="flex items-center gap-3 sm:gap-4 min-w-0">
        ...
        <div className="min-w-0">
          <h2 className="text-lg sm:text-xl font-bold text-ink-strong tracking-tight truncate">
            Gemma CogniVault AI
          </h2>
      ...
      <div className="flex items-center gap-2 sm:gap-3 sm:pr-2 flex-wrap">
        ...
        <Tooltip content="Start a fresh conversation" position="bottom">
          <button
            onClick={p.onNewChat}
            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-xl bg-[#e0e3e5] hover:bg-[#c2c6d6] dark:bg-[#272a31] dark:hover:bg-[#32353c] text-ink text-sm font-medium transition-colors"
          >
        ...
        >
          <button
            ...
            className={`hidden sm:inline-flex p-2.5 rounded-xl transition-colors ${p.isHistoryOpen ? "bg-[#a855f7] text-white shadow-[0_0_16px_rgba(168,85,247,0.4)]" : "bg-[#e0e3e5] hover:bg-[#c2c6d6] dark:bg-[#272a31] dark:hover:bg-[#32353c] text-ink"}`}
          >
            <History size={20} />
          </button>
        </Tooltip>
